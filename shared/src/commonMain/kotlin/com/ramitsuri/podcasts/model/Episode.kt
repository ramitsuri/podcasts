...
data class Episode(
    ...
    internal constructor(dbEpisode: GetEpisode) : this(
        id = dbEpisode.id,
    ...
    internal constructor(dbEpisode: GetEpisodesForPodcast) : this(
        id = dbEpisode.id,
        podcastId = dbEpisode.podcastId,
        podcastName = dbEpisode.podcastTitle,
        podcastAuthor = dbEpisode.podcastAuthor,
    ...
    internal constructor(dbEpisode: GetEpisodesForPodcasts) : this(
        id = dbEpisode.id,
        podcastId = dbEpisode.podcastId,
        podcastName = dbEpisode.podcastTitle,
        podcastAuthor = dbEpisode.podcastAuthor,
    ...
    internal constructor(dbEpisode: GetEpisodesInQueue) : this(
        id = dbEpisode.id,
        podcastId = dbEpisode.podcastId,
        podcastName = dbEpisode.podcastTitle,
        podcastAuthor = dbEpisode.podcastAuthor,
    ...
    internal constructor(dbEpisode: GetDownloadedEpisodes) : this(
        id = dbEpisode.id,
        podcastId = dbEpisode.podcastId,
        podcastName = dbEpisode.podcastTitle,
        podcastAuthor = dbEpisode.podcastAuthor,
    ...
    internal constructor(dbEpisode: GetFavoriteEpisodes) : this(
        id = dbEpisode.id,
        podcastId = dbEpisode.podcastId,
        podcastName = dbEpisode.podcastTitle,
        podcastAuthor = dbEpisode.podcastAuthor,
